...
ingredients:["Pork Shoulder","BBQ Sauce","Garlic","Salt","Black Pepper"],

instructions:["Season the pork.","Cook for 4 hours.","Shred the meat.","Mix with BBQ sauce."],

nutrition:["520 Calories","42g Protein","20g Fat"],

tips:["Use fresh meat.","Cook slowly.","Serve with bread."]
...
ingredients:["Beef","Cheese","Burger Bread","Tomato","Lettuce"],

instructions:["Grill the beef.","Toast the bread.","Add cheese.","Serve hot."],

nutrition:["650 Calories","35g Protein","28g Fat"],

tips:["Use fresh beef.","Don't overcook.","Add extra cheese."]
},
...
cookTime:"30 min",
servings:"3 People",
ingredients:["Pasta","Chicken","Cream","Parmesan","Butter"],
instructions:["Boil pasta.","Cook chicken.","Prepare sauce.","Mix together."],
nutrition:["480 Calories","30g Protein","18g Fat"],

tips:["Fresh parmesan tastes better.","Serve immediately.","Add parsley."]
